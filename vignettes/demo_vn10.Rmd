...
hist( unlist(vn.ci), main = 'Bootstrapped Distribution of I2C2',xlab='I2C2' )
```
...
hist( unlist(vn.NullDist), main = 'Null Distribution of I2C2',xlab='I2C2')
```

```{r beanplot}
#### Draw the beanplot
library(beanplot)
beanplot( data.frame(VN = vn.NullDist), border = 8, ylim = c(-0.5,1), cex.main = 1, cex.axis = 1.5, main = "I2C2-Ventricular RAVENS", ll = 0.001, col = c(8, 8, "#B2DF8A") )
...
legend('topright',c("I2C2","95% CI","Null"),lwd=2,cex=0.8,col=c(2,1,8))
```